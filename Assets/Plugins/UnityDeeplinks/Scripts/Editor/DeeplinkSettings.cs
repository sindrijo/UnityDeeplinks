...
namespace Deeplinks
{
    public sealed class DeeplinkSettings : ScriptableObject
    {
        ...
        private static void UpdateUrlSchemeIos(string oldScheme, string newScheme)
        {
            ...
            var findPropertyMethod = typeof(PlayerSettings).GetMethod("FindProperty",
                BindingFlags.Static | BindingFlags.NonPublic);
            Debug.Assert(findPropertyMethod != null, "findPropertyMethod != null");
            SerializedProperty iosUrlSchemesSerialized =
                (SerializedProperty) findPropertyMethod.Invoke(null, new object[] {"iOSURLSchemes"});
    ...
    public class DeeplinkSettingsWindow : EditorWindow
    {
        ...
        {
            var newSchemeValue =
                UriSchemeValidator.ValidatedSanitized(
                    EditorGUILayout.DelayedTextField("Url Scheme", DeeplinkSettings.UrlScheme));
